                        ...
                        <div class=" bg-white flex justify-between px-3 ">
                            ...
                            <div class=" flex space-x-2 py-3 items-center ">
                                <div class="flex items-center space-x-1">
                                    <label for=""class="text-sm">Order:</label>
                        ...
                        <div class="grid grid-cols-12 gap-3">
                            ...
                            @foreach ($posts as $post)
                                <div class="col-span-4 py-3">
                                    <!-- Card -->
                                    <div class="group flex flex-col h-full bg-white border  border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5  "
                                       >
                                        <div class="aspect-w-16 aspect-h-11">
                                            <img class="w-full object-contain object-top   rounded-xl"
                                                src="{{ asset('storage/' . $post->thumbnail) }}" alt="Blog Image">
                                        </div>
                                        <div class="my-6">
                                            <h3
