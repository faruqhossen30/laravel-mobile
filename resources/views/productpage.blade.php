                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{route('productpage')}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Products</a>
                        </div>
                    </li>
                ...
                <div class="grid grid-cols-12">
                    ...
                    <div class="col-span-6 pt-5">
                        ...
                        <div class="flex items-center mb-4 px-6">
                            <input id="default-checkbox" type="checkbox" value="" name="compare"  onchange="this.form.submit()"
                        ...
                        <div class="divide-y px-3">
                            ...
                            <div class="flex space-x-3  py-1 ">
                                <span class="text-blue-600 h-10 w-10">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-android2 w-10 h-10"
                                        viewBox="0 0 16 16">
                                        <path
                                ...
                                <tbody class="space-y-5">
                                    @foreach ($data as $attribute)
                                        <tr class="border group py-2">
                                            <td class="text-[#2c2f34] text-sm font-medium  border px-5 bg-[#f7f8f9] group-hover:bg-[#FFFFE6]">
                                                {{ $attribute['name'] }}
                                            </td>
