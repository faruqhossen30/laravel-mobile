                ...
                <div class="grid grid-cols-12 gap-6 ">
                    ...
                    <div class="col-span-9">
                            ...
                            <div class=" p-3 flex  space-x-2">
                                ...
                                <a href="">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor"
                                        class="w-4 h-4 text-gray-800 dark:text-white bi bi-grid-3x3-gap"
                                        viewBox="0 0 16 16">
                                        <path
                        ...
                        @foreach ($products as $product)
                            <div class=" flex bg-white border hover:shadow-lg p-3 mt-3">
                                <img src="{{ asset('storage/' . $product->thumbnail) }}" class="h-44 w-44"
                                    alt="">
                                <div class=" px-20 py-3 w-xl">
                                    <ul>
                                        <li>
                                            <p class=" font-medium text-xl">{{ $product->title }}</p>
                                        </li>
                                        <li>
                                            <p class=" font-normal"><span></span> {{ $product->categories->name }}</p>
                                        </li>
                                        <li>
                                            <p class=" font-normal">{{ $product->brand->name }}</p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="py-3">
                                    <p>${{ $product->price }}</p>
                                    <p> <span> 12%</span> off</p>
                                </div>
                            </div>
                        @endforeach
...
{{--
    @php
        $name = ['rahim', 'karim', 'alim']; //index array
        $car = array("brand"=>"Ford", "model"=>"Mustang", "year"=>1964); //associtive array
    @endphp --}}
@endsection
