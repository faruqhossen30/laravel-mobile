<footer class="px-4 pb-8 lg:pb-16 mx-auto bg-black py-14 lg:py-28 sm:px-6 lg:px-8 mt-10 lg:mt-[60px]">
    <!-- Grid -->
    <div class="text-center ">
        ...
        <div class="mt-12 ">
            {{-- <h3 class="text-lg font-extrabold text-white">WANT TO WORK TOGETHER?</h3> --}}
        </div>

        <!-- Social Brands -->
        <div class="inline-flex items-center mt-6 space-x-4 lg:space-x-9">
            <a href="https://www.behance.net/monodeepsamanta" target="_blank"
                ...
                <svg class="w-6 h-6 lg:w-8 lg:h-8" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
            ...
            <a href="https://dribbble.com/monodeepsamanta" target="_blank"
                class="inline-flex justify-center items-center w-10 lg:w-16 h-10 lg:h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800">
                <svg class="w-6 h-6 lg:w-8 lg:h-8" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <a href="https://www.flickr.com/photos/monodeepsamanta/" target="_blank"
                class="inline-flex justify-center items-center w-10 lg:w-16 h-10 lg:h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800">
                <img class="w-6 h-6" src="{{ asset('img/icon/flickr-website-logo-silhouette.png') }}" alt="">
            </a>
            <a class="inline-flex justify-center items-center w-10 lg:w-16 h-10 lg:h-16 text-center text-black hover:bg-primary bg-white hover:text-white hover:bg-[#FF003A] rounded-full focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
                href="#">
                <img class="w-6 h-6" src="{{ asset('img/icon/500px-monogram.png') }}" alt="">
            </a>
        ...
        <!-- End Social Brands -->
        <div class=" mt-11">
            <p class="text-sm text-white">© Copyright {{ date('Y') }} reserved by </p>
        </div>
    </div>
    <!-- End Grid -->
</footer>
